...
def build_style_tab(dialog: "UnifiedSettingsDialog") -> QWidget:
            ...
            dialog.axis_font_family.setCurrentText(dialog.style.get("axis_font_family", DEFAULT_STYLE["axis_font_family"]))
            axis_form.addRow("Font Family:", dialog.axis_font_family)

            dialog.axis_font_size = QSpinBox()
            dialog.axis_font_size.setRange(6, 48)
            dialog.axis_font_size.setValue(int(dialog.style.get("axis_font_size", DEFAULT_STYLE["axis_font_size"])))
            ...
            dialog.tick_font_size.setValue(int(dialog.style.get("tick_font_size", DEFAULT_STYLE["tick_font_size"])))
            ...
            dialog.pin_font_size.setValue(int(dialog.style.get("pin_font_size", DEFAULT_STYLE["pin_font_size"])))
            ...
            if primary_line is not None:
                primary_color = dialog._normalize_color(primary_line.get_color(), dialog.style.get("line_color"))
            ...
            if dialog.ax2 is not None:
                ...
                dialog.od_line_width.setValue(float(dialog.style.get("outer_line_width", DEFAULT_STYLE["outer_line_width"])))
