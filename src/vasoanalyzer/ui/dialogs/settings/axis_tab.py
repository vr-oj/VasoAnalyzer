...
def build_axis_tab(dialog: "DialogT", window) -> QWidget:
            ...
            dialog.yi_min = QDoubleSpinBox(suffix=top_units)
            dialog.yi_min.setRange(-1e6, 1e6)
            dialog.yi_min.setValue(round(dialog.ax.get_ylim()[0], 2))
            dialog.yi_max = QDoubleSpinBox(suffix=top_units)
            ...
            if dialog.ax2 is not None:
                ...
                dialog.yo_min = QDoubleSpinBox(suffix=bottom_units)
                dialog.yo_min.setRange(-1e6, 1e6)
                dialog.yo_min.setValue(round(dialog.ax2.get_ylim()[0], 2))
                dialog.yo_max = QDoubleSpinBox(suffix=bottom_units)
