...
class ProjectMixin:
    ...
    def refresh_project_tree(self):
        ...
        has_samples = any(exp.samples for exp in self.current_project.experiments)
        project_dock = getattr(self, "project_dock", None)
        if project_dock is not None and hasattr(project_dock, "set_empty_state_visible"):
            project_dock.set_empty_state_visible(not has_samples)
